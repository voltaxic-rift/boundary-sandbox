...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "postgresql" do |n|
    n.vm.hostname = "postgresql"
    n.vm.network "private_network", ip: "172.31.0.11", virtualbox__intnet: "internal"
    n.vm.provision "shell", path: "provision/postgresql.sh"
  end

  config.vm.define "redis" do |n|
    n.vm.hostname = "redis"
    n.vm.network "private_network", ip: "172.31.0.12", virtualbox__intnet: "internal"
